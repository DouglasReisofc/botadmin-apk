...
export function LandingPage() {
  ...
  return (
    <main className="landing-page" data-local-react-landing="true">
      ...
      <section className="landing-cta landing-cta--detailed py-10"><div className="container"><div className="landing-cta__panel"><div className="row align-items-center gy-4"><div className="col-lg-5 order-lg-2"><img className="landing-cta__image" src="/botadmin-landing/botadmin-commerce-v2.webp" alt="Pessoas organizando operações no BotAdmin" width={1200} height={900} loading="lazy" /></div><div className="col-lg-7 order-lg-1"><span className="landing-kicker">COMECE COM CLAREZA</span><h2 className="fw-bold mb-3">{text(settings.ctaTitle, defaults.ctaTitle)}</h2><p className="mb-3">{text(settings.ctaDescription, defaults.ctaDescription)}</p><ul className="landing-cta__list"><li>Configure suas regras em poucos minutos</li><li>Acompanhe grupos, campanhas e automações no mesmo painel</li><li>Tenha uma experiência organizada no celular e no computador</li></ul><a className="btn landing-btn landing-btn--neon rounded-pill px-4 fw-bold mt-3" href={ctaUrl}>{text(settings.ctaButtonLabel, "Começar agora")}</a></div></div></div></div></section>
