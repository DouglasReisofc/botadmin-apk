...
import {
  deleteAffiliateShopeeGroupDispatchForUser,
  updateAffiliateShopeeGroupDispatchForUser,
...
export async function PATCH(request: NextRequest, context: RouteContext) {
  try {
    ...
    const dispatch = await updateAffiliateShopeeGroupDispatchForUser(user.id, Math.floor(dispatchId), {
...
export async function DELETE(_request: NextRequest, context: RouteContext) {
  try {
    ...
    await deleteAffiliateShopeeGroupDispatchForUser(user.id, Math.floor(dispatchId));
