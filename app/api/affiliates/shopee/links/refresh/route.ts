...
import { refreshAffiliateShopeeLinksSnapshotForUser } from "lib/affiliate-shopee-links";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await refreshAffiliateShopeeLinksSnapshotForUser(user.id, { limit });
