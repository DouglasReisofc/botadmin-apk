...
import { deleteAffiliateMlLinkForUser, updateAffiliateMlLinkForUser } from "lib/affiliate-ml-links";
...
export async function DELETE(_request: NextRequest, context: RouteContext) {
  try {
    ...
    await deleteAffiliateMlLinkForUser(user.id, itemId);
...
export async function PATCH(request: NextRequest, context: RouteContext) {
  try {
    ...
    const link = await updateAffiliateMlLinkForUser(user.id, itemId, {
