...
import {
  listAffiliateMlGroupDispatchesForUser,
  upsertAffiliateMlGroupDispatchForUser,
...
export async function GET() {
  try {
    ...
    const dispatches = await listAffiliateMlGroupDispatchesForUser(user.id);
...
export async function POST(request: NextRequest) {
  try {
    ...
    const dispatch = await upsertAffiliateMlGroupDispatchForUser(user.id, {
